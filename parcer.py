...
# machine = WebDriverWait(browser, 40).until(expected_conditions.visibility_of_element_located((By.CSS_SELECTOR, "div.YearMakeModel"))).click()
#
# iframe = WebDriverWait(browser, 40).until(expected_conditions.frame_to_be_available_and_switch_to_it("GaugePageIFrame"))
# print(1, iframe)
#
# outter_tabs = browser.find_element_by_id("outerTabs")
# print(2, outter_tabs)
#
# try:
#     WebDriverWait(browser, 40).until(expected_conditions.visibility_of_element_located((By.ID, "ext-comp-1002")))
# except TimeoutException:
#     print(1, "Timed out waiting for page to load")
#     browser.quit()
#
# try:
#     WebDriverWait(browser, 60).until(expected_conditions.visibility_of_element_located((By.CLASS_NAME, "x-panel-bwrap")))
# except TimeoutException:
#     print(2, "Timed out waiting for page to load")
#     browser.quit()
#
# try:
#     WebDriverWait(browser, 40).until(expected_conditions.visibility_of_element_located((By.ID, "ext-gen20")))
# except TimeoutException:
#     print(3, "Timed out waiting for page to load")
#     browser.quit()
#
# try:
#     WebDriverWait(browser, 40).until(expected_conditions.visibility_of_element_located((By.ID, "gauge-page-tabs")))
# except TimeoutException:
#     print(4, "Timed out waiting for page to load")
#     browser.quit()
#
# try:
#     WebDriverWait(browser, 40).until(expected_conditions.visibility_of_element_located((By.CLASS_NAME, "x-tab-panel"
#                                                                                                         "-bwrap")))
# except TimeoutException:
#     print(5, "Timed out waiting for page to load")
#     browser.quit()
#
# try:
#     WebDriverWait(browser, 40).until(expected_conditions.visibility_of_element_located((By.CLASS_NAME, "x-tab-panel"
#                                                                                                                "-body-top")))
# except TimeoutException:
#     print(6, "Timed out waiting for page to load")
#     browser.quit()
#
# element = browser.find_element_by_id("pricing")
#
# if not element :
#     close = browser.find_element_by_xpath("//a[contains(@onclick,'vauto.ranking.GaugePage.onCloseClick()')]").click()
# else:
#     pass
#
# try:
#     e = browser.find_element_by_id("ext-gen915")
# except TimeoutException:
#     print(9, "Timed out waiting for page to load")
#     browser.quit()
#
#
# try:
#     WebDriverWait(browser, 40).until(expected_conditions.visibility_of_element_located((By.CLASS_NAME, "x-box-item")))
# except TimeoutException:
#     print(9, "Timed out waiting for page to load")
#     browser.quit()
#
...
# except TimeoutException:
#     print(10, "Timed out waiting for page to load")
#     browser.quit()
#
# try:
#     WebDriverWait(browser, 30).until(
#         expected_conditions.visibility_of_element_located((By.CLASS_NAME, "rcp-content")))
# except TimeoutException:
#     print(11, "Timed out waiting for page to load")
#     browser.quit()
#
...
#
# x_combo = browser.find_element(By.XPATH, "//div[contains(text(), '(All)')]")
# x_combo.click()
#
# try:
#     WebDriverWait(browser, 30).until(
#         expected_conditions.visibility_of_element_located((By.CLASS_NAME, "x-tab-strip-active")))
# except TimeoutException:
#     print(12, "Timed out waiting for page to load")
#     browser.quit()
#
...
#
# ext_gen352 = browser.find_element_by_tag_name("em")
# time.sleep(10)
#
...
# print(123, filename)
# os.rename(os.path.join(filepath, filename), os.path.join(filepath, vin.text + stock.text + ".xls"))
        ...
        try:
            ...
            while i < 10:
                ...
                try:
                    ...
                    # browser.find_element_by_id (outer_tabs)
                ...
                try:
                    ...
                    WebDriverWait(browser, 120).until(
                        expected_conditions.visibility_of_element_located((By.ID, pricing_div_container)))
                    print("Activate pricing")
                    '''active pricings competitive button'''
                    try:
                        WebDriverWait(browser, 50).until(
                            expected_conditions.visibility_of_element_located((By.CLASS_NAME, pricing_active_button)))
                    except TimeoutException:
                    ...
                    WebDriverWait(browser, 60).until(
                        expected_conditions.visibility_of_element_located(
                            (By.CLASS_NAME, "RefineSetContainer")))
                    ...
                    distance_drop_down = WebDriverWait(browser, 60).until(
                        expected_conditions.visibility_of_element_located(
                    ...
                    x_combo = WebDriverWait(browser, 30).until(
                        expected_conditions.visibility_of_element_located(
                            (By.XPATH, "//div[contains(text(), '(All)')]")))
                    x_combo.click()
                    ...
                    filename = max([filepath + "/" + f for f in os.listdir(filepath)], key=os.path.getctime)
                    print(123, filename)
                    os.rename(r'filepath, filename', r'filepath, vin.text + stock.text + ".xls"')
